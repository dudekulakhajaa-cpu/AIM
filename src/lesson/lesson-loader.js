...
export const CURRICULUM_MAP = {
    'how-computers-work': { semId: 'sem0', itemId: 'sem0_m1_c1' },
    'os-threading': { semId: 'sem0', itemId: 'sem0_m1_c2' },
    'developer-setup': { semId: 'sem0', itemId: 'sem0_m1_c3' },
    ...
    'data-structures': { semId: 'sem1', itemId: 'sem1_m1' },
    'algorithms-complexity': { semId: 'sem1', itemId: 'sem1_m2' },
    'recursion': { semId: 'sem1', itemId: 'sem1_m3' },
    'linked-lists': { semId: 'sem1', itemId: 'sem1_m4' },
    'trees': { semId: 'sem1', itemId: 'sem1_m5' },
    'graphs': { semId: 'sem1', itemId: 'sem1_m6' },
    'hash-tables': { semId: 'sem1', itemId: 'sem1_m7' },
    'dynamic-programming': { semId: 'sem1', itemId: 'sem1_m8' },
    'multithreading': { semId: 'sem1', itemId: 'sem1_m9' },
    ...
    'clean-code': { semId: 'sem3', itemId: 'sem3_m1' },
    'solid-principles': { semId: 'sem3', itemId: 'sem3_m2' },
    'creational-patterns': { semId: 'sem3', itemId: 'sem3_m3' },
    'game-patterns': { semId: 'sem3', itemId: 'sem3_m4' },
    'ecs': { semId: 'sem3', itemId: 'sem3_m5' },
    'unit-testing': { semId: 'sem3', itemId: 'sem3_m6' },
    'debugging': { semId: 'sem3', itemId: 'sem3_m7' },
    'profiling': { semId: 'sem3', itemId: 'sem3_m8' },
    'editor-interface': { semId: 'sem4', itemId: 'sem4_m1' },
    'gameplay-framework': { semId: 'sem4', itemId: 'sem4_m2' },
    'blueprints-basics': { semId: 'sem4', itemId: 'sem4_m3' },
    'material-shader-graph': { semId: 'sem4', itemId: 'sem4_m4' },
    'animation-blueprints': { semId: 'sem4', itemId: 'sem4_m5' },
    'unreal-physics': { semId: 'sem4', itemId: 'sem4_m6' },
    'umg-ui': { semId: 'sem4', itemId: 'sem4_m7' },
    'audio-sounds': { semId: 'sem4', itemId: 'sem4_m8' },
    'uobject-lifecycle': { semId: 'sem5', itemId: 'sem5_m1' },
    'aactor-components': { semId: 'sem5', itemId: 'sem5_m2' },
    'unreal-delegates': { semId: 'sem5', itemId: 'sem5_m3' },
    'reflection-system': { semId: 'sem5', itemId: 'sem5_m4' },
    'ai-systems': { semId: 'sem5', itemId: 'sem5_m5' },
    'inventory-cpp': { semId: 'sem5', itemId: 'sem5_m6' },
    'save-game': { semId: 'sem5', itemId: 'sem5_m7' },
    'multiplayer-arch': { semId: 'sem6', itemId: 'sem6_m1' },
    'networking-concepts': { semId: 'sem6', itemId: 'sem6_m2' },
    'actor-replication': { semId: 'sem6', itemId: 'sem6_m3' },
    'rendering-opt': { semId: 'sem6', itemId: 'sem6_m4' },
    'custom-memory': { semId: 'sem6', itemId: 'sem6_m5' },
    'advanced-ai': { semId: 'sem6', itemId: 'sem6_m6' },
    'rendering-pipeline': { semId: 'sem7', itemId: 'sem7_m1' },
    'opengl-concepts': { semId: 'sem7', itemId: 'sem7_m2' },
    'directx-concepts': { semId: 'sem7', itemId: 'sem7_m3' },
    'shader-basics': { semId: 'sem7', itemId: 'sem7_m4' },
    'lighting-models': { semId: 'sem7', itemId: 'sem7_m5' },
    'post-processing': { semId: 'sem7', itemId: 'sem7_m6' },
    'gpu-debugging': { semId: 'sem7', itemId: 'sem7_m7' },
    'console-publishing': { semId: 'sem8', itemId: 'sem8_m1' },
    'source-control': { semId: 'sem8', itemId: 'sem8_m2' },
    'team-workflows': { semId: 'sem8', itemId: 'sem8_m3' },
    'build-systems': { semId: 'sem8', itemId: 'sem8_m4' },
    'interview-prep': { semId: 'sem8', itemId: 'sem8_m5' },
    'portfolio-polish': { semId: 'sem8', itemId: 'sem8_m6' }
};
